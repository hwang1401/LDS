...
.btn-sm {
  padding: var(--semantic-spacing-xs, 4px) var(--semantic-spacing-md, 12px);
  font-size: var(--semantic-font-size-sm, 14px);
  min-height: 32px;
}

.btn-md {
  padding: var(--semantic-spacing-sm, 8px) var(--semantic-spacing-lg, 16px);
  font-size: var(--semantic-font-size-md, 16px);
  min-height: 40px;
}

.btn-lg {
  padding: var(--semantic-spacing-sm, 8px) var(--semantic-spacing-xl, 20px);
  font-size: var(--semantic-font-size-lg, 18px);
  min-height: 48px;
}

.btn-xl {
  padding: var(--semantic-spacing-md, 12px) var(--semantic-spacing-xl, 20px);
...
//# sourceMappingURL=design-systems_system-1_components_primitives_Button_index_jsx.870f8eb09f378ba3e7de.hot-update.js.map