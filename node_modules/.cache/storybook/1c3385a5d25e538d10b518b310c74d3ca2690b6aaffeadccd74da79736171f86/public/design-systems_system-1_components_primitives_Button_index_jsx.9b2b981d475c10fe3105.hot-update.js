...
.btn-primary.btn-filled .btn-icon img {
  /* Primary filled는 oncolor 토큰 적용 */
  filter: brightness(0) invert(1); /* oncolor 토큰 적용 (흰색) */
}

.btn-primary.btn-outlined .btn-icon img,
.btn-primary.btn-transparent .btn-icon img {
  /* 아이콘 기본 색상을 검정으로 변환 후 primary foreground 색상 필터 적용 */
  filter: brightness(0) saturate(100%) contrast(1000%); /* 검정색으로 변환 */
  opacity: 0.5; /* 동적 색상 적용을 위한 기본 opacity */
...
.btn-primary.btn-outlined:disabled .btn-icon img,
.btn-primary.btn-transparent:disabled .btn-icon img {
  background-color: var(--semantic-color-primary-foreground-1-disabled);
}

/* Secondary 버튼 아이콘 */
.btn-secondary.btn-filled .btn-icon img {
  /* Secondary filled는 foreground 토큰 적용 */
...
//# sourceMappingURL=design-systems_system-1_components_primitives_Button_index_jsx.9b2b981d475c10fe3105.hot-update.js.map