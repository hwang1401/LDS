...
var Button = function Button(_ref) {
  ...
  // 시멘틱 토큰으로 색상을 지정하기 위한 CSS 클래스
  var getIconClass = function getIconClass() {
    if (style === 'filled') {
      return 'btn-icon-filled';
    } else {
  ...
  if (iconOnly) {
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("button", _extends({
      ...
      className: "btn-icon ".concat(iconClass)
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("button", _extends({
    ...
    className: "btn-icon btn-icon-left ".concat(iconClass)
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_shared_components_Icon__WEBPACK_IMPORTED_MODULE_1__["default"], {
    ...
    className: "btn-icon btn-icon-right ".concat(iconClass)
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_shared_components_Icon__WEBPACK_IMPORTED_MODULE_1__["default"], {
...
//# sourceMappingURL=design-systems_system-1_components_primitives_Button_index_jsx.c1a2f9f649718f5fac77.hot-update.js.map