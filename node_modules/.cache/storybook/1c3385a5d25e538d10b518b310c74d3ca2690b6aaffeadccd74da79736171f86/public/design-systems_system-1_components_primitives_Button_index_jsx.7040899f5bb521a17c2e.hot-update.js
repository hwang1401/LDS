...
/* 버튼 크기 - 높이 기반으로 설정 */
.btn-xs {
  height: var(--semantic-height-global-xxxs, 12px);
  font-size: var(--semantic-font-size-xs, 12px);
}

.btn-sm {
  height: var(--semantic-height-global-xxs, 16px);
  font-size: var(--semantic-font-size-sm, 14px);
}

.btn-md {
  height: var(--semantic-height-global-xs, 20px);
...
.btn-xl {
  height: var(--semantic-height-global-md, 28px);
...
.btn-icon-only.btn-xs {
  min-width: var(--semantic-height-global-xxxs, 12px);
  height: var(--semantic-height-global-xxxs, 12px);
}

.btn-icon-only.btn-sm {
  min-width: var(--semantic-height-global-xxs, 16px);
  height: var(--semantic-height-global-xxs, 16px);
}

.btn-icon-only.btn-md {
  min-width: var(--semantic-height-global-xs, 20px);
  height: var(--semantic-height-global-xs, 20px);
}
...
.btn-icon-only.btn-xl {
  min-width: var(--semantic-height-global-md, 28px);
  height: var(--semantic-height-global-md, 28px);
}
...
//# sourceMappingURL=design-systems_system-1_components_primitives_Button_index_jsx.7040899f5bb521a17c2e.hot-update.js.map