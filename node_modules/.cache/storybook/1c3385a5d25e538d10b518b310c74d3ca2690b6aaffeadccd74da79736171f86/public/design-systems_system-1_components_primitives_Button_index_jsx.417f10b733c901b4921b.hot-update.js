...
/* 버튼 아이콘 색상 */
/* Primary 버튼 아이콘 */
.btn-primary.btn-filled .btn-icon img {
  /* oncolor 토큰 적용 */
  filter: invert(1) brightness(100%); /* white 대신 oncolor 토큰 적용 */
}

.btn-primary.btn-outlined .btn-icon img,
.btn-primary.btn-transparent .btn-icon img {
  /* primary foreground 토큰 적용 */
  color: var(--semantic-color-primary-foreground-1-rest);
}

.btn-primary.btn-outlined:hover:not(:disabled) .btn-icon img,
.btn-primary.btn-transparent:hover:not(:disabled) .btn-icon img {
  /* primary foreground hovered 토큰 적용 */
  color: var(--semantic-color-primary-foreground-1-hovered);
}

.btn-primary.btn-outlined:active:not(:disabled) .btn-icon img,
.btn-primary.btn-transparent:active:not(:disabled) .btn-icon img {
  /* primary foreground pressed 토큰 적용 */
  color: var(--semantic-color-primary-foreground-1-pressed);
}

.btn-primary.btn-filled:disabled .btn-icon img {
  /* primary foreground disabled 토큰 적용 */
  color: var(--semantic-color-primary-foreground-1-disabled);
}

/* Secondary 버튼 아이콘 */
.btn-secondary.btn-filled .btn-icon img {
  /* secondary foreground 토큰 적용 */
  color: var(--semantic-color-secondary-foreground-2-rest);
}

.btn-secondary.btn-outlined .btn-icon img,
.btn-secondary.btn-transparent .btn-icon img {
  /* secondary foreground 토큰 적용 */
  color: var(--semantic-color-secondary-foreground-2-rest);
}

.btn-secondary.btn-outlined:hover:not(:disabled) .btn-icon img,
.btn-secondary.btn-transparent:hover:not(:disabled) .btn-icon img {
  /* secondary foreground hovered 토큰 적용 */
  color: var(--semantic-color-secondary-foreground-2-hovered);
}

.btn-secondary.btn-outlined:active:not(:disabled) .btn-icon img,
.btn-secondary.btn-transparent:active:not(:disabled) .btn-icon img {
  /* secondary foreground pressed 토큰 적용 */
  color: var(--semantic-color-secondary-foreground-2-pressed);
}

.btn-secondary.btn-filled:disabled .btn-icon img,
.btn-secondary.btn-outlined:disabled .btn-icon img,
.btn-secondary.btn-transparent:disabled .btn-icon img {
  /* secondary foreground disabled 토큰 적용 */
  color: var(--semantic-color-secondary-foreground-1-disabled);
}

/* CTA 버튼 아이콘 */
.btn-cta.btn-filled .btn-icon img {
  /* oncolor 토큰 적용 */
  filter: invert(1) brightness(100%); /* white 대신 oncolor 토큰 적용 */
}

.btn-cta.btn-outlined .btn-icon img,
.btn-cta.btn-transparent .btn-icon img {
  /* cta foreground 토큰 적용 */
  color: var(--semantic-color-cta-foreground-2-rest);
}

.btn-cta.btn-outlined:hover:not(:disabled) .btn-icon img,
.btn-cta.btn-transparent:hover:not(:disabled) .btn-icon img {
  /* cta foreground hovered 토큰 적용 */
  color: var(--semantic-color-cta-foreground-2-hovered);
}

.btn-cta.btn-outlined:active:not(:disabled) .btn-icon img,
.btn-cta.btn-transparent:active:not(:disabled) .btn-icon img {
  /* cta foreground pressed 토큰 적용 */
  color: var(--semantic-color-cta-foreground-2-pressed);
}

.btn-cta.btn-filled:disabled .btn-icon img,
.btn-cta.btn-outlined:disabled .btn-icon img,
.btn-cta.btn-transparent:disabled .btn-icon img {
  /* cta foreground disabled 토큰 적용 */
...
//# sourceMappingURL=design-systems_system-1_components_primitives_Button_index_jsx.417f10b733c901b4921b.hot-update.js.map