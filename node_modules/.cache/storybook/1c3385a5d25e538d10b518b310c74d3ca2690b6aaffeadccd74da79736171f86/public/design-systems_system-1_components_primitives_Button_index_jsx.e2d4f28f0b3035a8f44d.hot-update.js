...
.btn-primary.btn-transparent .btn-icon img {
  filter: invert(44%) sepia(93%) saturate(1937%) hue-rotate(194deg) brightness(98%) contrast(101%); /* primary color */
}

.btn-primary.btn-outlined:hover:not(:disabled) .btn-icon img,
.btn-primary.btn-transparent:hover:not(:disabled) .btn-icon img {
  filter: invert(50%) sepia(85%) saturate(1700%) hue-rotate(194deg) brightness(95%) contrast(90%); /* primary hovered */
}

.btn-primary.btn-outlined:active:not(:disabled) .btn-icon img,
.btn-primary.btn-transparent:active:not(:disabled) .btn-icon img {
  filter: invert(60%) sepia(70%) saturate(1400%) hue-rotate(194deg) brightness(90%) contrast(85%); /* primary pressed */
}
...
.btn-primary.btn-filled:disabled .btn-icon img {
  filter: invert(80%) sepia(10%) saturate(200%) hue-rotate(180deg) brightness(96%) contrast(90%); /* disabled */
}

/* Secondary 버튼 아이콘 */
.btn-secondary.btn-filled .btn-icon img {
  filter: invert(42%) sepia(0%) saturate(0%) hue-rotate(222deg) brightness(95%) contrast(95%); /* secondary foreground */
}

.btn-secondary.btn-outlined .btn-icon img,
.btn-secondary.btn-transparent .btn-icon img {
  filter: invert(42%) sepia(0%) saturate(0%) hue-rotate(222deg) brightness(95%) contrast(95%); /* secondary color */
}
...
.btn-cta.btn-transparent .btn-icon img {
  filter: invert(58%) sepia(79%) saturate(458%) hue-rotate(85deg) brightness(96%) contrast(87%); /* cta color */
}
...
//# sourceMappingURL=design-systems_system-1_components_primitives_Button_index_jsx.e2d4f28f0b3035a8f44d.hot-update.js.map