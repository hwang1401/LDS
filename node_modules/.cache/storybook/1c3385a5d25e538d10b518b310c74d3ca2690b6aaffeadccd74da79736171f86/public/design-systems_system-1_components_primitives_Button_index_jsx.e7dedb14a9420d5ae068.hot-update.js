...
var Button = function Button(_ref) {
  ...
  var getIconSize = function getIconSize(btnSize) {
    var sizeMap = {
      ...
      sm: 'var(--semantic-size-icon-xs)',
      md: 'var(--semantic-size-icon-sm)',
      lg: 'var(--semantic-size-icon-md)',
      xl: 'var(--semantic-size-icon-lg)'
    };
...
//# sourceMappingURL=design-systems_system-1_components_primitives_Button_index_jsx.e7dedb14a9420d5ae068.hot-update.js.map