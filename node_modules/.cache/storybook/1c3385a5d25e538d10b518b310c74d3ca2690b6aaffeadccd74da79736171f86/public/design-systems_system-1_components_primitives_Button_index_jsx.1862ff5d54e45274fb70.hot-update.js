...
.btn-primary.btn-outlined {
  ...
  color: var(--semantic-color-primary-foreground-inverse-rest);
...
.btn-secondary.btn-filled:hover:not(:disabled) {
  background-color: var(--semantic-color-secondary-background-2-hovered);
}

.btn-secondary.btn-filled:active:not(:disabled) {
  background-color: var(--semantic-color-secondary-background-2-pressed);
}
...
.btn-secondary.btn-filled:disabled {
  background-color: var(--semantic-color-secondary-background-2-disabled);
...
//# sourceMappingURL=design-systems_system-1_components_primitives_Button_index_jsx.1862ff5d54e45274fb70.hot-update.js.map