...
/* 버튼 크기 - 높이 기반으로 설정 */
.btn-xs {
  height: var(--foundation-height-xxxs, 24px);
  font-size: var(--semantic-font-size-xs, 12px);
}

.btn-sm {
  height: var(--foundation-height-xxs, 32px);
  font-size: var(--semantic-font-size-sm, 14px);
}

.btn-md {
  height: var(--foundation-height-xs, 40px);
  font-size: var(--semantic-font-size-md, 16px);
}

.btn-lg {
  height: var(--foundation-height-sm, 48px);
  font-size: var(--semantic-font-size-lg, 18px);
}

.btn-xl {
  height: var(--foundation-height-md, 56px);
...
.btn-icon-only.btn-xs {
  min-width: var(--foundation-height-xxxs, 24px);
  height: var(--foundation-height-xxxs, 24px);
}

.btn-icon-only.btn-sm {
  min-width: var(--foundation-height-xxs, 32px);
  height: var(--foundation-height-xxs, 32px);
}

.btn-icon-only.btn-md {
  min-width: var(--foundation-height-xs, 40px);
  height: var(--foundation-height-xs, 40px);
}

.btn-icon-only.btn-lg {
  min-width: var(--foundation-height-sm, 48px);
  height: var(--foundation-height-sm, 48px);
}

.btn-icon-only.btn-xl {
  min-width: var(--foundation-height-md, 56px);
  height: var(--foundation-height-md, 56px);
}
...
//# sourceMappingURL=design-systems_system-1_components_primitives_Button_index_jsx.b0bcb4a06144995f7c0a.hot-update.js.map